...
program
  ...
  .action(async options => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:3010/cms/con-category2s?conCategory1Id=67`,
      axiosOptions)
      ...
      const spreadsheetId = '1ynQhO1Yhnr8iKwOoBgFlJKdmu2rOuLjlKvW8aplk57k'
