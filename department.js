...
program
  ...
  .action(async options => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:3010/cms/con-category2s?conCategory1Id=69`,
      axiosOptions)
      ...
      const spreadsheetId = '11SFiUyzCFZNryfmcWFudm4Q_1TA13xZoLXJEj6QB7b0'
