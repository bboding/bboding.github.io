...
program
  ...
  .action(async options => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:3010/cms/con-category2s?conCategory1Id=60`,
      axiosOptions)
      ...
      const spreadsheetId = '1ZasRnHyVP7jT0w-dwDKD7ASOcl1eY0o451mYaQKQr6E'
