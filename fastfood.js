...
program
  ...
  .action(async options => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:3010/cms/con-category2s?conCategory1Id=61`,
      axiosOptions)
      ...
      const spreadsheetId = '1EaWwpQM-bUW-Gzb2jCRjd7U8-XDT2VTtiXXg0hf8rrw'
